...
if(response.data.role === "admin"){
  ...
  return (
    <div className='flex flex-col items-center h-screen justify-items-center bg-gradient-to-b
      from-teal-600 from-50% to-gray-100 to-50% space-y-6'>
      <h2 className='font-Pacifico text-3xl text-white py-8'>Employee management system</h2>
